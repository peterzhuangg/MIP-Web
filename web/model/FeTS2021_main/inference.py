from model.FeTS2021_main.models import EncoderDecoderModule, EncoderDecoderModuleFPN, EncoderDecoderModuleUnetPP
import numpy as np
import glob
from model.FeTS2021_main.predict_utils import get_3d_images_for_validation_nogt, normalize_mean_std, image_zpad
import torch
import os
import matplotlib.pyplot as plt
import time
from model.FeTS2021_main.patch_utils import find_bbox
import cv2
...
def save_nifti(fname, dir_out, out_label):
    ...
    f_old = os.path.join(dir_out, fname.split('/')[-1].split('.')[0] + '_Procssing_FeTS.txt')
    f_new = os.path.join(dir_out, fname.split('/')[-1].split('.')[0] + '_success_FeTS.nii.gz')
...
def run_model(input_path,output_path):
    ...
    ap.add_argument("-np", "--nifti_path", type=str, default=input_path)
    ap.add_argument("-op", "--out_path", type=str, default=output_path)
    args = vars(ap.parse_args())
    print('flag1')
    print(input_path)
    # ------- Load Model Definition -------- #
    path_to_ckpt_s1 = './model/FeTS2021_main/weights/stage1/resnet50-scse/epoch=12-step=1442.ckpt'
    ...
    path_to_ckpt_s2_0= './model/FeTS2021_main/weights/stage2/Unet-resnet50-scse/epoch=33-step=3467.ckpt'
    ...
    path_to_ckpt_s2_1 = './model/FeTS2021_main/weights/stage2/Unetpp-resnet50-scse/epoch=19-step=2039.ckpt'
    ...
    path_to_ckpt_s2_6 = './model/FeTS2021_main/weights/stage2/FPN-se_resnet50/epoch=30-step=2107.ckpt'
    ...
    path_to_ckpt_s2_7 = './model/FeTS2021_main/weights/stage2/FPN-dpn92/epoch=31-step=4351.ckpt'
    ...
    path_to_ckpt_s2_8 = './model/FeTS2021_main/weights/stage2/FPN-inceptionresnetv2/epoch=29-step=4079.ckpt'
    ...
    path_to_ckpt_s2_9 = './model/FeTS2021_main/weights/stage2/FPN-densenet169/epoch=22-step=2345.ckpt'
    ...
    path_to_ckpt_s2_10 = './model/FeTS2021_main/weights/stage2/FPN-efficientnet-b5/epoch=5-step=1217.ckpt'
...
#inp = '../../users/123/BraTS2021_00024_flair.nii.gz'
#out ='../../users/123_result/'
#run_model(inp,out)